...
export const Community: React.FC = () => {
  ...
  return (
    <div className="space-y-16">
      ...
      <section className="bg-gray-100 dark:bg-gray-800 py-12 px-6 rounded-xl max-w-5xl mx-auto">
        <div className="space-y-8">
          ...
          <div className="bg-white dark:bg-gray-700 p-6 rounded-xl">
            ...
            <div className="space-y-4">
              <p className="text-gray-700 dark:text-gray-300">
                To donate, simply scan the appropriate QR code above or send funds to the corresponding cryptocurrency address. We currently accept:
              </p>
              
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 text-gray-700 dark:text-gray-300">
                <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                  <h4 className="font-semibold mb-2 flex items-center gap-2">
                    <XRPLogo className="w-5 h-5 text-brand-primary" />
                    XRP
                  </h4>
                  <p>
                    Donate using your XUMM wallet or any XRP-compatible wallet. Scan the QR code or copy the address.
                  </p>
                </div>
                
                <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                  <h4 className="font-semibold mb-2 flex items-center gap-2">
                    <XDCLogo className="w-5 h-5 text-gray-700 dark:text-gray-300" />
                    XDC
                  </h4>
                  <p>
                    Send XDC from any compatible wallet such as D'CENT, MetaMask (with XDC network), or XDCPay.
                  </p>
                </div>
                
                <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                  <h4 className="font-semibold mb-2 flex items-center gap-2">
                    <SiCardano className="w-4 h-4 text-blue-600" />
                    Cardano (ADA)
                  </h4>
                  <p>
                    Donate using Daedalus, Yoroi, or any other Cardano-compatible wallet. Make sure to use the correct address.
                  </p>
                </div>
                ...
                <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                  ...
                  <p>
                    Use your favorite Bitcoin wallet to send BTC to our donation address. Always verify the address before sending.
                  </p>
                </div>
              </div>
              ...
              <div className="mt-4 text-sm text-gray-500 dark:text-gray-400">
                <p>
                  <strong>Note:</strong> Please ensure you're sending each cryptocurrency on its native network. 
                  Donations sent on incorrect networks may be lost.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="text-center">
            <p className="text-gray-700 dark:text-gray-300">
              If you have any questions about donations or need assistance, please contact us at <a href="mailto:support@xrpchat.app" className="text-brand-primary hover:underline">support@xrpchat.app</a>
            </p>
          </div>
        </div>
      </section>
